...
class Adafruit_ILI9341 : public Adafruit_SPITFT {
    public:
        Adafruit_ILI9341(PinName _CS, PinName _DC, PinName _MOSI, PinName _SCLK, PinName _RST = NC, PinName _MISO = NC);
        Adafruit_ILI9341(SPI *spi, PinName _CS, PinName _DC, PinName _RST = NC);
