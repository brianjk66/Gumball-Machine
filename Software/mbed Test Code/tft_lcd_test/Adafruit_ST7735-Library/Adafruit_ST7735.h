...
*/
/**************************************************************************/
  Adafruit_ST7735(PinName cs, PinName dc, PinName mosi, PinName sclk, PinName rst = NC, PinName miso = NC) : 
  Adafruit_ST77xx(cs, dc, mosi, sclk, rst, miso) {}
