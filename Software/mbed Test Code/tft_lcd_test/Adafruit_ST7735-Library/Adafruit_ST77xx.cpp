...
Adafruit_ST77xx::Adafruit_ST77xx(PinName cs, PinName dc, PinName mosi, PinName sclk, PinName rst, PinName miso) 
  : Adafruit_SPITFT(ST7735_TFTWIDTH_128, ST7735_TFTHEIGHT_160, cs, dc, mosi, sclk, rst, miso), _colstart(0), _rowstart(0)
{
}
...
*/
/**************************************************************************/
Adafruit_ST77xx::Adafruit_ST77xx(SPI *spi, PinName cs, PinName dc, PinName rst) 
  : Adafruit_SPITFT(ST7735_TFTWIDTH_128, ST7735_TFTHEIGHT_160, spi, cs, dc, rst), _colstart(0), _rowstart(0)
{
}
